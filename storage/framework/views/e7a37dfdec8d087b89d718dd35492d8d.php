...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url('<?php echo e(asset('assets/media/auth/bg6.jpg')); ?>');
            }

            [data-bs-theme="dark"] body {
                background-image: url('<?php echo e(asset('assets/media/auth/bg6-dark.jpg')); ?>');
            }
        </style>
        <!--end::Page bg image-->
        ...
        <div class="d-flex flex-column flex-column-fluid flex-lg-row">
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                ...
                <div class="d-flex flex-center flex-lg-start flex-column">
                    <!--begin::Logo-->
                    <img alt="Logo" src="<?php echo e(asset('assets/img/logo_sin_fondo.jpeg')); ?>" width="100%" />
                    <!--end::Logo-->
                    <!--begin::Title-->
                    <br>
...
<?php /**PATH C:\laragon\www\mecanico\resources\views/auth/login.blade.php ENDPATH**/ ?>