...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        ...
                        <a href="<?php echo e(url('home')); ?>">
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <img alt="Logo" src="<?php echo e(asset('assets/img/logo.jpeg')); ?>" width="100%" />
                                </div>
                                <!-- <div class="col-md-8">
    ...
    <script src="<?php echo e(asset('assets/js/ajaxGlobal.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js')); ?>"></script>
    <?php $__env->startSection('js'); ?>
    <?php echo $__env->yieldSection(); ?>
    <?php $__env->startSection('formularioBusquedaJs'); ?>
    <?php echo $__env->yieldSection(); ?>
...
<?php /**PATH C:\laragon\www\mecanico\resources\views/layouts/app.blade.php ENDPATH**/ ?>